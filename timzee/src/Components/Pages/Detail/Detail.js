  ...
  function initPromise() {
    ...
    return new Promise(function (res, rej) {
      ...
      const loadMaterials = async () => {
          ...
          const result4 = await axios.get("https://localhost:44330/api/ProductMaterials/GetAllProductMaterials")
          setAllMaterials(result4?.data)
          
      };
      const loadColors = async () => {

          const result3 = await axios.get("https://localhost:44330/api/ProductColors/GetAllProductColors")
      ...
      const loadSizes = async () => {
          ...
          const result2 = await axios.get("https://localhost:44330/api/ProductSizes/GetAllProductSizes")
          setAllSizes(result2?.data)
        
      };
      const loadTypes = async () => {
        const result1 = await axios.get("https://localhost:44330/api/Types/GetAllTypes");
      ...
      const loadCategories = async () => {
          ...
          const result = await axios.get("https://localhost:44330/api/Categories/GetAllCategories");
